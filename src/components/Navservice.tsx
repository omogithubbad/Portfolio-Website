...
const Navbar = () => {
  return (
    <nav className="flex justify-between items-center px-25 py-5 bg-[#111111] text-white">
      <div>
      ...
      <div className="flex gap-8 items-center">
        ...
        <button className="ring-1 rounded-full px-6 py-2 cursor-pointer hover:bg-[#82ff1f] hover:text-[#111111]">
          Contact Me
        </button>
      </div>
    </nav>

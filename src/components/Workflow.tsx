  ...
  return (
    <section className="grid grid-cols-2 gap-2 px-20 my-30">
      <div className="flex flex-col">
        ...
        <h1 className="text-[80px] font-verdana leading-none text-[#1A1A1A]">
          My Creative Workflow
        </h1>

        <button className="ring-0 rounded-full px-5 py-2 text-[#1A1A1A] font-verdana text-base bg-[#82FF1F] hover:bg-amber-50 transition duration-300 hover:animate-bounce flex justify-center items-center w-fit mt-15 border-none">
      ...
      <div className="divide-y mx-20">
        <div>
          <h1 className="text-4xl font-verdana text-[#1A1A1A] pt-5">
            1. Discovery
          </h1>
          <p className="text-[#1A1A1A] font-figtree text-base py-5">
        ...
        <div>
          ...
          <p className="text-[#1A1A1A] font-figtree text-base py-5 divide-y border-b">

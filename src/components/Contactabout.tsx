  ...
  return (
    <section className="bg-[#1A1A1A] pt-30 text-[#FFFFFF]">
      <div className="flex flex-col justify-center items-center bg-[#0d0d0d] mx-20 py-21 rounded-3xl">
        ...
        <h1 className="text-[#FFFFFF] text-[80px] font-[Helvetica,Verdana,Arial,sans-serif] px-13 leading-none">
          Let’s Turn your Ideas <br /> <span className='pl-45'>into Reality</span>
        </h1>
        ...
        <a
          ...
          className="text-xl mt-10 border-b-2 border-zinc-700 pt-1 hover:text-lime-400 transition text-[32px] flex items-center justify-center" >
           ...
           <HiArrowTurnDownRight className='mr-1 mt-1' />
